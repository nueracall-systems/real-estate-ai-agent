...
// Official Cloud API doesn't offer a pre-send "is this number on WhatsApp"
// check the way Baileys does - we only find out when the send itself
// fails. Returning null (unknown) keeps the same interface as baileysProvider.
